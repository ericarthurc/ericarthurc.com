...
<header>
	<div class="header-logo">
		...
		>
			<g transform="matrix(1,0,0,1,-116.5,-116.5)">
				<g transform="matrix(1,0,0,1,3.625,46.625)">
					<circle id="bg" cx="496.375" cy="453.375" r="381.375" style="stroke-width:4.25px;" />
				</g>
				<g transform="matrix(1,0,0,1,-7.10543e-14,6.25)">
					<g transform="matrix(0.984925,0,0,0.984925,5.07538,11.2613)">
						<circle id="cir-top" cx="502.5" cy="249.5" r="99.5" />
					</g>
					<g transform="matrix(0.984925,0,0,0.984925,5.07538,254.261)">
						<circle id="cir-bottom" cx="502.5" cy="249.5" r="99.5" />
					</g>
					<path
						id="base"
